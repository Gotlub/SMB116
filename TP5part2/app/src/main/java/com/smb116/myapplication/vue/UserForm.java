    ...
    private void ajouterUFListener() {
        ajouterUF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                values.put(UserContentProvider.NOM_COLONNE_NOM, nom);
                values.put(UserContentProvider.NOM_COLONNE_PRENOM, prenom);
                values.put(UserContentProvider.NOM_COLONNE_COURRIEL, courriel);
